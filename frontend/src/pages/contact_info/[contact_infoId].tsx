...
const EditContact_info = () => {
  ...
  const { contact_infoId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: contact_infoId }));
  }, [contact_infoId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: contact_infoId, data }));
...
EditContact_info.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditContact_info;
