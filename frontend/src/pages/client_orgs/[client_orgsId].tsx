...
const EditClient_orgs = () => {
  ...
  const { client_orgsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: client_orgsId }));
  }, [client_orgsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: client_orgsId, data }));
...
EditClient_orgs.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditClient_orgs;
