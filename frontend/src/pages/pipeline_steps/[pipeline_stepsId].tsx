...
const EditPipeline_steps = () => {
  ...
  const { pipeline_stepsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: pipeline_stepsId }));
  }, [pipeline_stepsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: pipeline_stepsId, data }));
...
EditPipeline_steps.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditPipeline_steps;
