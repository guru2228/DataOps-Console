...
const EditPayload_record_spec = () => {
  ...
  const { payload_record_specId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: payload_record_specId }));
  }, [payload_record_specId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: payload_record_specId, data }));
...
EditPayload_record_spec.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditPayload_record_spec;
