...
const EditData_extract_template = () => {
  ...
  const { data_extract_templateId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: data_extract_templateId }));
  }, [data_extract_templateId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: data_extract_templateId, data }));
...
EditData_extract_template.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditData_extract_template;
