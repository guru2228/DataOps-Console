...
const IntegrationsTablesPage = () => {
  ...
  const [filters] = useState([
    { label: 'IntegrationName', title: 'integration_name' },
  ]);

  const hasCreatePermission =
    currentUser && hasPermission(currentUser, 'CREATE_INTEGRATIONS');
      ...
      <SectionMain>
        ...
        <CardBox className='mb-6' cardBoxClassName='flex flex-wrap'>
          {hasCreatePermission && (
            <BaseButton
              className={'mr-3'}
              href={'/integrations/integrations-new'}
              color='info'
              label='New Item'
            />
          )}
