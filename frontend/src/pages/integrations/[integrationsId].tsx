...
const EditIntegrations = () => {
  ...
  const { integrationsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: integrationsId }));
  }, [integrationsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: integrationsId, data }));
...
EditIntegrations.getLayout = function getLayout(page: ReactElement) {
  return (
