...
const EditData_extract_request = () => {
  ...
  const { data_extract_requestId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: data_extract_requestId }));
  }, [data_extract_requestId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: data_extract_requestId, data }));
...
EditData_extract_request.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditData_extract_request;
