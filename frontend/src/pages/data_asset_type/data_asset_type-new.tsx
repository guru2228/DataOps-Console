...
import { create } from '../../stores/data_asset_type/data_asset_typeSlice';
...
Data_asset_typeNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_DATA_ASSET_TYPE'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default Data_asset_typeNew;
