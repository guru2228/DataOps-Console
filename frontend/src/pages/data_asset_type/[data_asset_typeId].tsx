...
const EditData_asset_type = () => {
  ...
  const { data_asset_typeId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: data_asset_typeId }));
  }, [data_asset_typeId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: data_asset_typeId, data }));
...
EditData_asset_type.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditData_asset_type;
