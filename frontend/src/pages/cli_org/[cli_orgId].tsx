...
const EditCli_org = () => {
  ...
  const { cli_orgId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: cli_orgId }));
  }, [cli_orgId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: cli_orgId, data }));
...
EditCli_org.getLayout = function getLayout(page: ReactElement) {
  return (
