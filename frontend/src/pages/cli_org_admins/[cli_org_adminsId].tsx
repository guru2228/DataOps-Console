...
const EditCli_org_admins = () => {
  ...
  const { cli_org_adminsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: cli_org_adminsId }));
  }, [cli_org_adminsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: cli_org_adminsId, data }));
...
EditCli_org_admins.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditCli_org_admins;
