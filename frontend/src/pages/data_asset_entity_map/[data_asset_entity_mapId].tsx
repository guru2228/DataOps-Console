...
const EditData_asset_entity_map = () => {
  ...
  const { data_asset_entity_mapId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: data_asset_entity_mapId }));
  }, [data_asset_entity_mapId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: data_asset_entity_mapId, data }));
...
EditData_asset_entity_map.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditData_asset_entity_map;
