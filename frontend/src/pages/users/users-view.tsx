    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>Client_orgs</p>

            <p>{users?.client_org?.name ?? 'No data'}</p>
          </div>

          <>
            <p className={'block font-bold mb-2'}>Data_assets Owner</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.data_assets_owner &&
                      Array.isArray(users.data_assets_owner) &&
                      users.data_assets_owner.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
              ...
              {!users?.data_assets_owner?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
