...
const EditData_extract_dag = () => {
  ...
  const { data_extract_dagId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: data_extract_dagId }));
  }, [data_extract_dagId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: data_extract_dagId, data }));
...
EditData_extract_dag.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditData_extract_dag;
