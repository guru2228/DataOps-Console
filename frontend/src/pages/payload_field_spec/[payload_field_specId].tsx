...
const EditPayload_field_spec = () => {
  ...
  const { payload_field_specId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: payload_field_specId }));
  }, [payload_field_specId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: payload_field_specId, data }));
...
EditPayload_field_spec.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditPayload_field_spec;
