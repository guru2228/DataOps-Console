...
const CardUsers = ({
  ...
  return (
    <div className={'p-4'}>
      ...
      >
        {!loading &&
          data_asset_type.map((item, index) => (
            <li
              key={item.id}
              ...
              >
                ...
                <div className='ml-auto '>
                  <ListActionsPopover
                    ...
                    onEdit={onEdit}
                    itemId={item.id}
                    pathEdit={`/data_asset_type/data_asset_type-edit/?id=${item.id}`}
                    pathView={`/data_asset_type/data_asset_type-view/?id=${item.id}`}
        ...
        {!loading && data_asset_type.length === 0 && (
