...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/pipelines/pipelinesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configurePipelinesCols';
...
const TableSamplePipelines = ({
  ...
  useEffect(() => {
    if (pipelinesNotify.showNotification) {
      notify(
        pipelinesNotify.typeNotification,
        pipelinesNotify.textNotification,
      );
    }
  }, [pipelinesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/pipelines/pipelines-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {pipelines && Array.isArray(pipelines) && !showGrid && (
        <ListPipelines
          pipelines={pipelines}
          loading={loading}
...
export default TableSamplePipelines;
