...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/connectors/connectorsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureConnectorsCols';
...
const TableSampleConnectors = ({
  ...
  useEffect(() => {
    if (connectorsNotify.showNotification) {
      notify(
        connectorsNotify.typeNotification,
        connectorsNotify.textNotification,
      );
    }
  }, [connectorsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/connectors/connectors-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {connectors && Array.isArray(connectors) && !showGrid && (
        <ListConnectors
...
export default TableSampleConnectors;
