...
const ListData_asset_entity_map = ({
  ...
  return (
    <>
      <div className='relative overflow-x-auto p-4 space-y-4'>
        ...
        {!loading &&
          data_asset_entity_map.map((item) => (
            <CardBox
              hasTable
              isList
              key={item.id}
            ...
            >
              ...
              >
                ...
                >
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>
                      {dataFormatter.data_asset_infoOneListFormatter(
                        item.asset_aide,
                      )}
                    </p>
                  </div>
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/data_asset_entity_map/data_asset_entity_map-edit/?id=${item.id}`}
                  pathView={`/data_asset_entity_map/data_asset_entity_map-view/?id=${item.id}`}
                  hasUpdatePermission={hasUpdatePermission}
                />
              </div>
            </CardBox>
          ))}
        {!loading && data_asset_entity_map.length === 0 && (
...
export default ListData_asset_entity_map;
