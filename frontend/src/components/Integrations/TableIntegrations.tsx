...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/integrations/integrationsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureIntegrationsCols';
...
const TableSampleIntegrations = ({
  ...
  useEffect(() => {
    if (integrationsNotify.showNotification) {
      notify(
        integrationsNotify.typeNotification,
        integrationsNotify.textNotification,
      );
    }
  }, [integrationsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/integrations/integrations-view/?id=${id}`);
  };
...
export default TableSampleIntegrations;
