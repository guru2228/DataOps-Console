...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '4df14a981a8982b61552378918030454',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'DataOps Console <app@flatlogic.app>',
  ...
  project_uuid: 'c70a5790-0065-4e07-96e0-315db5351741',
  flHost:
...
config.pexelsQuery = 'data integration concept art';
config.host =
