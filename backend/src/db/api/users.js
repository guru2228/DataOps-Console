...
module.exports = class UsersDBApi {
  static async create(data, globalAccess, options) {
    ...
    await users.setClient_org(data.data.client_org || null, {
      transaction,
    });
  ...
  static async update(id, data, globalAccess, options) {
    ...
    await users.setClient_org(data.client_org || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.data_assets_owner = await users.getData_assets_owner({
      transaction,
    });
    ...
    output.client_org = await users.getClient_org({
      transaction,
    });
